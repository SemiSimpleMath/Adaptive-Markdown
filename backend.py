...
from am_docs import (  # noqa: E402
    ...
    list_all_docs, _doc_path_for, _doc_slug_from_path,
...
# State class + global singleton live in am_state so the other extracted
# modules (am_upload, future am_routes / am_hooks) can import the live
# state without a circular dep through backend.
...
# Drop-to-upload handlers + LLM-based PDF/LaTeX conversion live in their
# own modules. Imported here so make_app() finds them when registering
# /upload and /upload-asset routes.
from am_upload import upload_md, upload_asset  # noqa: E402
